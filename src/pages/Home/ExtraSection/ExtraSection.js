    ...
    return (
        <div className="text-light mt-5 ">
            <div className="extra-section py-3 mb-5">
                <h1 className="text-dark text-center my-4">EXPLORE OUR BLOG</h1>
                <Row xs={1} md={2}>
                    <Col>
                        <div className="d-md-flex align-items-center justify-content-between container">
                            ...
                            <div className="ms-md-5">
                                ...
                                <p>As one of the #1 things to do in Activland, we’re confident that what we do is excellent and provides real value for money.However, if for any reason we let you down, you’ll be eligible for our 100% satisfaction guarantee and we’ll refund you your money, no questions asked.</p>
                            </div>
                        </div>
                    </Col>
                    <Col>
                    ...
                    <Col>
                        <div className="d-md-flex align-items-center justify-content-between container ">
                            <div className="ms-md-5">
                                ...
                                <p>Our exhilarating whitewater rafting, kayaking, and zip lining activities make for fun and memorable adventures. We strive to enhance the lives of our guests by creating the best human-powered outdoor adventures available.</p>
                            </div>
                            <div className="d-flex align-items-center justify-content-center">
                ...
                <div className="m-md-4">
                    ...
                    <Row xs={1} md={3} className="g-3">
                        <Col md={6}>
                            <Carousel>
                                <Carousel.Item>
                                    <img className="rounded latest-stories" src="https://i.ibb.co/dQBzGk1/Virgin-Voyager.jpg" alt="" />
                        ...
                        <Col md={3}>
                            <div className="container">
                                <div>
                                    <img className="rounded-pill " src="https://i.ibb.co/ZKJv1C9/Cacao-Fruit-and-roasted-seeds-Costa-Rica.jpg" alt="" />
                                </div>
                                <div>
                                    <h6>History</h6>
